    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-sm text-gray-500">View project status and progress</p>
        </div>
        ...
        {projects.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-400 text-xs">Contact your project manager to get started</p>
          </div>
        ) : (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-3">Project Updates</h3>
          <p className="text-gray-500 text-sm mb-4">View recent check-ins and progress photos</p>
          <button className="w-full bg-blue-600 text-white py-2.5 rounded-xl font-medium hover:bg-blue-700 transition-colors touch-manipulation">
            View Updates
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 text-sm mb-4">Share your thoughts and concerns about the project</p>
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Daily check-in submitted</p>
          ...
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Project phase updated</p>
